...
-x disables resolving javac executeable symlinks if javac symlink points from '/usr/bin/java' --> '/usr/lib/jvm/jdk-8u50/bin/javac' it won't detect a JDK because "/usr/lib" is not part JDK Installation

...
def loadcmd():
    ...
    parser.add_argument('-i','--intensity', metavar='NORMAL|MIN|OS|CUSTOM', default=SENTINEL, help='Search Intensity where Min does minimal non extensive searches based on the search opperations and OS. OS Searches Standard Official Java Installation Paths only')
